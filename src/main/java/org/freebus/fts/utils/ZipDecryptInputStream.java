 ...
 * Zip decryptor.
 *
 * Taken from http://blog.alutam.com/2009/10/31/reading-password-protected-zip-files-in-java
 */
public final class ZipDecryptInputStream extends InputStream
{
   ...
   /**
    * Create a ZIP decryptor stream.
    * @param stream - the input stream that points to the ZIP.
