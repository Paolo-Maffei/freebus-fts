 ...
 */
public final class ActionVdxInspector extends GenericAction
{
   ActionVdxInspector()
   {
      super(I18n.getMessage("ActionVdxInspector_Label"), I18n.getMessage("ActionVdxInspector_ToolTip"), "icons/filefind");
   }
   ...
   public void triggered(SelectionEvent event)
   {
      ...
      fileDialog.setText(I18n.getMessage("ActionVdxInspector_Open_File"));
