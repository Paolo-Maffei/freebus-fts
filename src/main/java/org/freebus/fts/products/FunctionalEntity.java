...
{
   @Id
   @Column(name = "functional_entity_id", columnDefinition = "INT", unique = true, nullable = false)
   private int id;
   
   @Column(name = "manufacturer_id", columnDefinition = "INT", nullable = false)
   ...
   @Column(name = "fun_functional_entity_id", columnDefinition = "INT")
