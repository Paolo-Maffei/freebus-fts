...
public enum ApplicationType
{
    ...
    * contents.
    */
   Memory_Response(0x240, 6, 3, 15, null, MemoryResponse.class),
    ...
    */
   Memory_Read(0x200, 6, 3, 3, Memory_Response, MemoryRead.class),
    ...
    * contents.
    */
   Memory_Write(0x280, 6, 3, 15, null, MemoryWrite.class),
