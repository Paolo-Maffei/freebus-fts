...
import org.freebus.knxcomm.exception.KNXConnectException;
 ...
 */
public abstract class Ft12Link extends ListenableConnection implements Link
{
   private Logger logger = Logger.getLogger(Ft12Link.class);
