...
import org.freebus.knxcomm.jobs.Telegrams;
import org.freebus.knxcomm.jobs.TelegramSearchConditions;
...
public class TestTelegrams
{
 ...
 Telegrams ts = new Telegrams();
      ...
      t1.setApplication(ApplicationType.Memory_Read);
      ...
      t2.setApplication(ApplicationType.Memory_Response);
      ...
      t3.setApplication(ApplicationType.Memory_Read);
      ...
      t4.setApplication(ApplicationType.ADC_Response);
