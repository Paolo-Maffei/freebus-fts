package org.freebus.fts.client.app;
...
public final class Application extends org.jdesktop.application.Application
{
   ...
   private void startupUpgradeDatabase(int progress) throws Exception
   {
      ...
      catch (LiquibaseException e)
      {
         ...
         {
            Dialogs.showExceptionDialog(e, I18n.formatMessage("FTS.ErrUpgradeDatabaseFailed", Environment.getAppDir()));
            Runtime.getRuntime().exit(1);
         }
      }
      finally
